...
In backend add your local gemini API key in .env file(same folder as main.py at python scripts folder) with the name API_KEY, as well as the domain of your frontend port/domain using ORIGIN namev
